...
import { RotationListFiltersForm } from "../../config/RotationListFiltersForm";

type RotationsListFiltersProps = {
  onUpdate: (filters: any) => void;
};

export const RotationsListFilters = React.memo(RotationsListFiltersBase);

export function RotationsListFiltersBase(props: RotationsListFiltersProps) {
  ...
  const filterForm = use(RotationListFiltersForm, { transient: true });
  filterForm.build();

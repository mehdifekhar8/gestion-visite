...
import { DoctorListFiltersForm } from "../../config/DoctorListFiltersForm";

type DoctorsListFiltersProps = {
  onUpdate: (filters: any) => void;
};

export const DoctorsListFilters = React.memo(DoctorsListFiltersBase);

export function DoctorsListFiltersBase(props: DoctorsListFiltersProps) {
  ...
  const filterForm = use(DoctorListFiltersForm, { transient: true });
  filterForm.build();

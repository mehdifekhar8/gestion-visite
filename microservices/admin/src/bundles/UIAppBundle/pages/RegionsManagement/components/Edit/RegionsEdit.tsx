...
import { RegionEditForm } from "../../config/RegionEditForm";
...
export function RegionsEdit(props: { id: string }) {
  const UIComponents = useUIComponents();
  const t = useTranslate();
  const form = use(RegionEditForm, { transient: true });
  ...
  return (
    <UIComponents.AdminLayout>
      <Ant.PageHeader
        title={t("management.regions.edit.header")}
        ...
        extra={
          features.view
            ? [
                <Link
                  key="view"
                  to={router.path(Routes.REGIONS_VIEW, {
                    params: { id: props.id },
                  })}
                >
      ...
      <Ant.Card>
        ...
        {!isLoading && !error && (
          <Ant.Form
            ...
            initialValues={document as Region}
